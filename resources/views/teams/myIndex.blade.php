<x-app-layout>
    ...
    <div class="pokedex">
        <header class="pokedex__header">
            ...
            <h1 class="pokedex__title">Mes équipes</h1>
                ...
                @foreach ($teams as $team)
                    <li class="pokemon-card">
                        ...
                        <p style="margin-top:0.5rem">
                            <a href="{{ route('teams.edit', $team) }}">Modifier</a>
                        </p>

                        <form action="{{ route('teams.destroy', $team) }}" method="post" style="margin-top:0.5rem">
                            @csrf
                            @method('DELETE')
                            <button type="submit" onclick="return confirm('Supprimer cette équipe ?')">Supprimer</button>
                        </form>
                    </li>
                @endforeach
            </ul>
